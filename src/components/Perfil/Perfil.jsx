                ...
                <div className="Perfil-Container">
                    ...
                    <div className="Perfil-Social grid-item-2">
                        <div className="Perfil-Social-2">
                            <div>
                                <h2 className="Perfil-Title" data-aos="fade-down-right">Desenvolvedor Web e Mobile  <span className="Perfil-Title-span"> Expertise em JavaScript</span></h2>
                                <p className="Perfil-Describe" data-aos="fade-up-right">Com 8 anos de imersão na tecnologia, nos últimos 3 anos, tenho me especializado em tecnologias JavaScript, tais como React, Vue.js, TypeScript e Angular, além de possuir experiência em desenvolvimento mobile com React Native. Essa expertise me capacita a criar interfaces web dinâmicas e eficientes para aplicativos móveis.</p>
                            </div>
